...
with open(file_to_save, "w") as txt_file:
    ...
    largest_county_summary = (
        f"-------------------------\n"
        f"County with largest Turnover: {largest_county_turnout}\n"
        f"Largest turout County's Vote Count: {largest_county_vote:,}\n"
        f"Largest turout County's Vote Percentage: {largest_county_percentage:.1f}%\n"
        f"-------------------------\n")
